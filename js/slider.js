document.addEventListener('DOMContentLoaded', () => {
    ...
    slider
		.add({ name: 'slide1', timeout: 7 * 1000 })  
		.add({ name: 'slide2', timeout: 7 * 1000 })
        .add({ name: 'slide3', timeout: 7 * 1000 })
		.add({ name: 'slide4', timeout: 7 * 1000 })
        .add({ name: 'slide5', timeout: 7 * 1000 }) 
        .add({ name: 'slide6', timeout: 7 * 1000 }) 		
